            ...
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  <a class="nav-link" href="{{asset('front/index.html')}}"> Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item ">
                ...
                @if (Route::has('login'))
                            ...
                            @auth
                                <li class="nav-item"><a href="{{ url('/dashboard') }}" class="nav-link text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a></li><
                            @else
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="about_img-container">
              <img src="{{asset('front/images/about.png')}}" alt="">
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="admission_img-container">
              <img src="{{asset('front/images/admission.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="why_img-container">
              <img src="{{asset('front/images/why.png')}}" alt="">
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="determine_img-container">
              <img src="{{asset('front/images/determine.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="contact_img-box">
                <img src="{{asset('front/images/students.jpg')}}" alt="">
              </div>
            </div>
          </div>
        </div>
